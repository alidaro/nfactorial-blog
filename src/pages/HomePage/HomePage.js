    ...
    <div className = "main-holder bg-light-blue">
      <header className='header' style = {{
        ...
        <div className='container'>
          ...
          <h1 style={{ color: 'red' }} className='header-title ls-2'>nFactorial Incubator Blog</h1>
            ...
            <form className='flex align-center justify-center' onSubmit={(e) => handleSearchResult(e)}>
              <div className='header-input-group flex align-stretch'>
                  <input type = "text" className='form-control fs-20' placeholder='Искать' onChange={(e) => handleSearchTerm(e)} />
                  <span className='form-text font-rubik fs-14 fw-4'>{erroMsg}</span>
                  <button type = "submit" className='form-btn bg-black flex align-center justify-center'>
